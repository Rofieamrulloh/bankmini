<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-exchange"></i> Debit Nasabah</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <button style="margin-bottom:15px" class="btn-primary "><a style="color:white; text-decoration:none;" href="?page=tabunganmasuk&aksi=tambah">Penyetoran</a></button>
              <button style="margin-left:15px" class="btn-primary"><a style="color:white; text-decoration:none;" href="?page=tabunganmasuk&aksi=laporan">Laporan</a></button>
                ...
                <tbody>
                  ...
                  ?>                  <tr>
                    ...
                    <td><?php if ($TRANSAKSI['status_transaksi']=='1'){
		                 ...
		                 ?></td>
                    <td>
                     <a href="index.php?page=tabunganmasuk&aksi=edit&id=<?php echo $TRANSAKSI['id_transaksi']; ?>">Edit</a> |
                     <a href="index.php?page=tabunganmasuk&aksi=hapus&id=<?php echo $TRANSAKSI['id_transaksi']; ?>">Delete</a></td>
                  </tr>
                  <?php
                    $NO++;
                   };
