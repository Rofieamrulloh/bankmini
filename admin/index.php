...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="../index.php">Saturday Bank</a>
      <!-- Navbar Right Menu-->
      <ul class="app-nav">
        <li class="app-search">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Tabungan Nasabah</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="?page=tabunganmasuk"><i class="icon fa fa-arrow-right"></i>Tabungan Masuk</a></li>
            <li><a class="treeview-item" href="?page=tabungankeluar"><i class="icon fa fa-arrow-left"></i>Tabungan Keluar</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="?page=invoice"><i class="app-menu__icon fa fa fa-envelope-o"></i><span class="app-menu__label">Invoice</span><i class="treeview-indicator"></i></a>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-address-book"></i><span class="app-menu__label">Laporan</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="?page=laporan&?page=laporan&aksi=laporannasabah"><i class="icon fa fa-circle-o"></i>Rekap Transaksi Masuk</a></li>
            <li><a class="treeview-item" href=#><i class="icon fa fa-circle-o"></i>Rekap Transaksi Keluar</a></li>
            <li><a class="treeview-item" href=#><i class="icon fa fa-circle-o"></i>Rekap Data Nasabah</a></li>
            <li><a class="treeview-item" href=#><i class="icon fa fa-circle-o"></i>Rekap Kelas</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-cogs"></i><span class="app-menu__label">Pengaturan Kelas</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
