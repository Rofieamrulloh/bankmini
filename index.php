        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="inc/login.php" class="btn btn-light rounded-pill text-primary py-2 px-4 ms-lg-5">Daftar/Masuk</a>
                </div>
            </nav>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">You Never Worry Alone</h1>
                            <p class="text-white pb-3 animated zoomIn">Manage Your Money Wisely</p>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">Saturday Bank adalah aplikasi perbankan digital yang membantu kamu dalam melakukan aktivitas finansial. Produk perdana Saturday Bank adalah rekening Tabungan, yang dapat mempermudah pengelolaan aktivitas finansial harian & menyediakan tabungan dalam satu rekening dengan bunga yang tinggi.</p>
                        <div class="row g-3 mb-4">
                            <div class="col-12 d-flex">
                                ...
                                <div class="ms-4">
                                    <h6>Keamanan Dalam Bertransaksi</h6>
                                    <span>Akses ke informasi akun dan transaksi kamu dilindungi oleh 2 faktor autentikasi</span>
                                </div>
                            </div>
                            <div class="col-12 d-flex">
                                <div class="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
                                ...
                                <div class="ms-4">
                                    <h6>Sudah Terdaftar Dalam OJK</h6>
                                    <span>Akan selalu melindungi data dan informasi kamu dengan teknologi enkripsi terkini</span>
                                </div>
                            </div>
                        </div>
